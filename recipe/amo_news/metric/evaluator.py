...
from recipe.amo_news.metric.scorer import UniEvaluator
from recipe.amo_news.metric.utils import add_question, print_scores
            ...
            # Calculate summary-level score for 'coherence' and 'relevance'
                ...
                for i in range(n_data):
                    if dim == 'coherence':
                        ...
                        assert False, 'The dimension {} is not defined for summarization.'.format(dim)
...
def get_evaluator(task, max_length=1024, device='cuda', cache_dir=None):
