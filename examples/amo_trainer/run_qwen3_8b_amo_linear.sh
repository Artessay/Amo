...
PROJECT_NAME="amo_grpo_math500"

EXPERIMENT_NAME=${EXPERIMENT_NAME:-"qwen3_8b-math500-linear_scalarization"}

REWARD_PATH="['$WORKSPACE/verl/utils/reward_score/amo_math/math_accuracy.py','$WORKSPACE/verl/utils/reward_score/dynamic_math/math_conciseness.py','$WORKSPACE/verl/utils/reward_score/dynamic_math/math_format.py']"
