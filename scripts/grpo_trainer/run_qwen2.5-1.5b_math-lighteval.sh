...
REWARD_FUNCTION_PATH="['$WORKSPACE/recipe/amo_math/math_accuracy.py','$WORKSPACE/recipe/amo_math/math_conciseness.py','$WORKSPACE/recipe/amo_math/math_clarity.py']"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.ppo_mini_batch_size=125 \
